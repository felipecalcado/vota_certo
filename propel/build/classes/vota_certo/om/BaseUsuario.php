...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    public function setIdCidade($v)
    {
        ...
        if ($this->id_cidade !== $v) {
            $this->id_cidade = $v;
            $this->modifiedColumns[] = UsuarioPeer::ID_CIDADE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->senha = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->id_cidade = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::ID_CIDADE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setSenha($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setIdCidade($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::ID_CIDADE)) $criteria->add(UsuarioPeer::ID_CIDADE, $this->id_cidade);
