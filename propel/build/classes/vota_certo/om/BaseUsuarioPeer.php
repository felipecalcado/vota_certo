...
abstract class BaseUsuarioPeer
{
    ...
    const ID_CIDADE = 'usuario.id_cidade';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Usuario', 'Senha', 'IdCidade', 'Admin', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuario', 'senha', 'idCidade', 'admin', ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::ID, UsuarioPeer::USUARIO, UsuarioPeer::SENHA, UsuarioPeer::ID_CIDADE, UsuarioPeer::ADMIN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO', 'SENHA', 'ID_CIDADE', 'ADMIN', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'usuario', 'senha', 'id_cidade', 'admin', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Usuario' => 1, 'Senha' => 2, 'IdCidade' => 3, 'Admin' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuario' => 1, 'senha' => 2, 'idCidade' => 3, 'admin' => 4, ),
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::ID => 0, UsuarioPeer::USUARIO => 1, UsuarioPeer::SENHA => 2, UsuarioPeer::ID_CIDADE => 3, UsuarioPeer::ADMIN => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO' => 1, 'SENHA' => 2, 'ID_CIDADE' => 3, 'ADMIN' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario' => 1, 'senha' => 2, 'id_cidade' => 3, 'admin' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioPeer::ID_CIDADE);
    ...
    public static function doCountJoinCidade(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UsuarioPeer::ID_CIDADE, CidadePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Usuario objects pre-filled with their Cidade objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCidade(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Usuario) to $obj2 (Cidade)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Usuario) to the collection in $obj2 (Cidade)
                $obj2->addUsuario($obj1);
