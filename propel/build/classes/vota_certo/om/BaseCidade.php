...
abstract class BaseCidade extends BaseObject implements Persistent
{
    ...
    public function setIdEstado($v)
    {
        ...
        if ($this->id_estado !== $v) {
            $this->id_estado = $v;
            $this->modifiedColumns[] = CidadePeer::ID_ESTADO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_estado = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CidadePeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->candidatosScheduledForDeletion !== null) {
                if (!$this->candidatosScheduledForDeletion->isEmpty()) {
                    foreach ($this->candidatosScheduledForDeletion as $candidato) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CidadePeer::ID_ESTADO)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CidadePeer::doValidate($this, $columns)) !== true) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CidadePeer::ID_ESTADO)) $criteria->add(CidadePeer::ID_ESTADO, $this->id_estado);
     ...
     * @throws PropelException
     */
    public function getEstado(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEstado === null && ($this->id_estado !== null) && $doQuery) {
    ...
    public function setCandidatos(PropelCollection $candidatos, PropelPDO $con = null)
    {
        ...
        foreach ($candidatosToDelete as $candidatoRemoved) {
            $candidatoRemoved->setCidade(null);
        }
    ...
    public function removeCandidato($candidato)
    {
        if ($this->getCandidatos()->contains($candidato)) {
            ...
            $this->candidatosScheduledForDeletion[]= $candidato;
            $candidato->setCidade(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aEstado instanceof Persistent) {
              $this->aEstado->clearAllReferences($deep);
            }
